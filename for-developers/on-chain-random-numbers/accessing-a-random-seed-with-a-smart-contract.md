...
The  [RandomAura](https://github.com/poanetwork/posdao-contracts/blob/master/contracts/RandomAuRa.sol) contract allows smart contracts to access a random, on-chain number generated within the protocol. It is generated by the validators themselves, using a RANDAO-like process \([https://github.com/randao/randao](https://github.com/randao/randao)\). Chains that can access this functionality must be running Parity's AuRa based consensus on v 2.7.1+.
